...
function get_cached_domain(domain){
	...
	if(dd != null && dd.block_flag && parseInt(dd.timestamp) >= unix_timestamp() - DEFAULT_CACHE_TTL){
		return dd;
	}
	return null;
}
...
chrome.webNavigation.onBeforeNavigate.addListener(
	function(details){
		...
		if(details.url == null || details.url.indexOf(".") == -1 || details.url.indexOf(g_block_ip) > -1){
			return;
		}
